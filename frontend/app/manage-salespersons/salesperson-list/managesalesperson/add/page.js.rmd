// // frontend/app/manage-salespersons/salesperson-list/managesalesperson/add/SalespersonOnboardingWizard.jsx
// "use client";
...
// const InputField = ({ label, name, type = "text", placeholder, required, value, onChange, icon, disabled }) => (
...
// const SelectField = ({ label, name, options, required, value, onChange, icon }) => (
//   <div className="flex flex-col">
//     <Label required={required}>{label}</Label>
//     <div className="relative">
...
// const TextareaField = ({ label, name, rows = 3, placeholder, required, value, onChange }) => (
//   <div className="flex flex-col">
//     <Label required={required}>{label}</Label>
//     <textarea
//       name={name}
...
// const FileField = ({ label, name, accept, required, onChange, fileName }) => (
//   <div className="flex flex-col">
//     <Label required={required}>{label}</Label>
...
// // ─── INCENTIVE SLABS ────────────────────────────────────────────────────────────
// const IncentiveSlabs = ({ slabs, onChange }) => {
//   const addSlab = () => onChange([...slabs, { id: Date.now(), from: "", to: "", rate: "" }]);
//   const removeSlab = (id) => onChange(slabs.filter((s) => s.id !== id));
...
// // ─── STEP 1: BASIC INFO ─────────────────────────────────────────────────────────
// const Step1 = ({ data, onChange, onFile }) => {
...
// // ─── STEP 3: KYC ───────────────────────────────────────────────────────────────
// const Step3 = ({ data, onChange, onFile }) => (
//   <div>
...
// // ─── STEP 4: PROFESSIONAL ──────────────────────────────────────────────────────
// const Step4 = ({ data, onChange, onFile }) => (
//   <div>
...
//         onChange={(e) => onFile("resumeFile", e.target.files?.[0])}
...
// const Step5 = ({ data, onChange, onSlabChange }) => (
//   <div>
...
//           {[
//             { value: "flat", label: "Flat Amount", icon: "💵", desc: "Fixed ₹ per sale" },
//             { value: "percentage", label: "Percentage", icon: "📊", desc: "% of sale value" },
//           ].map((type) => (
//             <button key={type.value} type="button"
//               onClick={() => onChange({ target: { name: "commissionType", value: type.value } })}
...
//       <IncentiveSlabs slabs={data.incentiveSlabs} onChange={onSlabChange} />
...
//           </div>
//           <button type="button"
//             onClick={() => onChange({ target: { name: "bonusEligible", value: !data.bonusEligible } })}
...
// // ─── STEP 6: PAYOUT ─────────────────────────────────────────────────────────────
// const Step6 = ({ data, onChange, onFile }) => {
...
//           onChange={(e) => onFile("cancelledChequeFile", e.target.files?.[0])}
...
//   const handleSlabChange = (newSlabs) => {
...
//       fd.append("bonusEligible", formData.bonusEligible);
...
//   const stepProps = { data: formData, onChange: handleChange, onFile: handleFile, onSlabChange: handleSlabChange };
