                ...
                <div className="bg-white w-full max-w-[1400px]">
                    <div className="bg-white w-full px-4 sm:px-6 py-4">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            <h1 className="text-xl sm:text-2xl font-normal text-gray-700">
                                Total email <strong className="font-semibold">recipients ({totalRecipients})</strong>
                            </h1>
                    ...
                    <div className="w-full px-4 sm:px-6 py-6 pb-8">
                        <div className="w-full">
                            <div className="mb-8">
                                <h2 className="text-base sm:text-lg font-normal text-gray-800 mb-6">
                                    We will deliver this email to <strong className="font-semibold">({totalRecipients}) recipients</strong>
                                </h2>
                                <div className="space-y-3 text-sm sm:text-base text-red-500">
                                    <p>
