...
export default function TodaysLeadsTable({ leads = [], onDelete, onEdit }: TodaysLeadsTableProps) {
...
// // frontend/app/leads/TodaysLeadsTable.tsx - WITH PAGINATION
// "use client";

// import { useState, useMemo, useEffect } from "react";
// import { FaEdit, FaClipboard, FaChevronLeft, FaChevronRight } from "react-icons/fa";
// import { apiGet } from "@/utils/api";
// import AssignLeadsModal from "./AssignLeadsModal";
...
//   useEffect(() => {
//     setCurrentPage(1);
//   }, [selectedProduct, selectedStatus, searchTerm, sortOrder]);
...
//       {/* PAGINATION INFO */}
//       <div className="bg-white p-2 rounded shadow-sm mb-2 flex justify-between items-center text-sm">
...
//       {/* PAGINATION CONTROLS */}
//       {filteredLeads.length > 0 && (
//         <div className="bg-white p-3 rounded shadow-md mt-4 flex flex-wrap justify-center items-center gap-2">
//           {/* Previous Button */}
//           <button
//             onClick={goToPreviousPage}
//             disabled={currentPage === 1}
//             className={`px-3 py-2 rounded flex items-center gap-1 text-sm font-semibold ${
//               currentPage === 1
