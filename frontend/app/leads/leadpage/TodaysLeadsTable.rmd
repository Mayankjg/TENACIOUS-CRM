// // frontend/app/leads/TodaysLeadsTable.tsx - CLICK TO EDIT PAGE
// "use client";
...
//   // Navigate to edit page when cell is clicked
...
//             <tr>
//               <th className="border cursor-pointer p-2 w-10">
//                 <input
//                   type="checkbox"
//                   onChange={handleSelectAll}
//                   checked={
...
//               <th className="border cursor-pointer p-2 text-left font-semibold">PERSON</th>
//               <th className="border cursor-pointer p-2 text-left font-semibold">COMPANY</th>
//               <th className="border cursor-pointer p-2 text-left font-semibold">PHONE</th>
//               <th className="border cursor-pointer p-2 text-left font-semibold">CITY</th>
//               <th className="border cursor-pointer p-2 text-left font-semibold">STATUS</th>
//               <th className="border cursor-pointer p-2 text-center font-semibold">ACT</th>
//             </tr>
//           </thead>
//         </table>
//       </div>
...
//                 <span
//                   className={`px-2 py-1 rounded text-white text-xs ${lead.leadStatus === "Open"
//                     ? "bg-emerald-500"
//                     : lead.leadStatus === "Closed"
//                       ? "bg-indigo-600"
//                       : "bg-gray-400"
